...
if rows[1][0].button('Get SMA'):
    try:
        ...
        chart_data = pd.merge(chart_data_sma50[['date', 'SMA_50']], chart_data_sma200[['date', 'SMA_200']], on = 'date',
                              how = 'inner')
        ...
        st.line_chart(chart_data.set_index('date'), y = ['SMA_50', 'SMA_200', 'Price'], x_label = 'Date', y_label = 'Price')
    except Exception as e:
        st.exception(f'Exception: {e}')
